    ...
    <div className={styles.nosotros_container}>
      <div className={styles.text_container}>
        <div className={styles.text}>
          ...
          <strong>Pelach Propiedades</strong> es una de las empresas inmobiliarias con mayor
            tradición y reputación por la calidad de su producto, integridad
            profesional y servicio al cliente. <br /><br /> Nuestro conocimiento tanto del
            mercado inmobiliario como de las necesidades de los clientes más
            exigentes, nos permite ofrecerle la clave para un buen negocio
            inmobiliario. <br /><br /> <strong>Pelach Propiedades</strong> ha prestado sus servicios a gran
            cantidad de clientes satisfechos, estableciendo relaciones a largo
            plazo con compradores, vendedores y profesionales inmobiliarios. <br /><br />

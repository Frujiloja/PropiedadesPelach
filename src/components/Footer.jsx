    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        horaciopelach@gmail.com
          ...
          | <a className={styles.contact} target="_blank" href="https://api.whatsapp.com/send/?phone=5491152280786&text=Hola%2C+me+interesa+m%C3%A1s+informaci%C3%B3n+sobre+una+propiedad.&type=phone_number&app_absent=0">11 5228-0786</a>
        </p>
      </div>
      <div className={styles.container}>
        <p className={styles.text}>
